...
// ---------------------------------------------------------------------------
const String OurEmail = "repinis@gmail.com";
const String EmailSubj = "EBars.Demos.";
// ---------------------------------------------------------------------------

__fastcall TEBarsDemoRatingForm::TEBarsDemoRatingForm(TComponent* Owner) : TForm(Owner) {
}

// ---------------------------------------------------------------------------
void __fastcall TEBarsDemoRatingForm::rgRateChanged(TObject *Sender) {
...
void __fastcall TEBarsDemoRatingForm::btnSendClick(TObject *Sender) {
	...
	try {
		...
		ShellExecute(Handle, L"OPEN", s.w_str(), NULL, NULL, SW_SHOWMAXIMIZED);
	}
	__finally {
